...
namespace fantec
{
    internal class AssetFileMagi : AssetFileBase
    {
        //実際にロードするパス
        ...
        public AssetFileMagi(AssetFileManager assetFileManager, AssetFileInfo fileInfo, IAssetFileSettingData settingData)
