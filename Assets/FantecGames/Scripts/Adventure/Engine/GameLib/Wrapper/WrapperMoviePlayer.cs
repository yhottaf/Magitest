#if !UNITY_2018_2_OR_NEWER && !FANTEC_DISABLE_MOVIE
...
namespace fantec
{
    ...
    /// ムービー再生処理のラッパー
    /// </summary>
    [AddComponentMenu("fantec/Lib/Wrapper/WrapperMoviePlayer")]
    public class WrapperMoviePlayer : MonoBehaviour
    {
		...
		IEnumerator CoCancelMovieTexture()
		{
			...
			yield return new WaitForSecondsRealtime(cancelFadeTime);
			yield return StartCoroutine(CoStopMovieTexture() );
		}
...
#elif UNITY_2018_2_OR_NEWER || UNITY_WEBGL || FANTEC_DISABLE_MOVIE
