...
namespace fantec
{
    ...
    /// セーブデータ管理クラス
    /// </summary>
    [AddComponentMenu("fantec/ADV/Internal/AdvSaveManager")]
    public class AdvSaveManager : MonoBehaviour
    {
        ...
        public virtual void WriteSaveData(AdvEngine engine, AdvSaveData saveData)
        {
            ...
            //セーブ
            saveData.SaveGameData(CurrentAutoSaveData, engine, FantecToolKit.CreateResizeTexture(CaptureTexture, CaptureWidth, CaptureHeight));
