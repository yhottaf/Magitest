...
namespace fantec
{
    ...
    internal class AdvCommandVideo : AdvCommand
    {
            ...
            : base(row)
        {
            ...
            this.cameraName = ParseCell<string>(AdvColumName.Arg2);
            this.loop = ParseCellOptional<bool>(AdvColumName.Arg3, false);
            this.cancel = ParseCellOptional<bool>(AdvColumName.Arg4, true);
