...
namespace fantec
{
    ...
    public abstract class AdvCommand
    {
        ...
        //セルが空かどうか
        public bool IsEmptyCell(AdvColumName name)
        {
        ...
        public T ParseCell<T>(AdvColumName name)
        {
        ...
        public T ParseCellOptional<T>(AdvColumName name, T defaultVal)
        {
        ...
        public bool TryParseCell<T>(AdvColumName name, out T val)
        {
        ...
        public T[] ParseCellArray<T>(AdvColumName name)
        {
        ...
        public T[] ParseCellOptionalArray<T>(AdvColumName name, T[] defaultArray)
        {
        ...
        public bool TryParseCellArray<T>(AdvColumName name, out T[] array)
        {
        ...
        public System.Nullable<T> ParseCellOptionalNull<T>(AdvColumName name) where T : struct
        {
        ...
        {
            return ParseCellLocalized(AdvColumName.Text.QuickToString());
        }
        ...
        public bool CheckSkipPage()
        {
            ...
            return languageManager.CheckSkipPage(this.RowData, AdvColumName.Text.QuickToString());
        }
        //ローカライズによってスキップすべきテキストデータかチェック
        public bool CheckSkipByLocalize()
        {
            ...
            return languageManager.CheckSkipByLocalize(this.RowData, AdvColumName.Text.QuickToString());
        }

        //シナリオラベルを解析・取得
        public virtual string ParseScenarioLabel(AdvColumName name)
        {
            string label;
        ...
        public string CommandLabel
        {
            get
            {
                string commandName = this.GetType().ToString().Replace("fantec.AdvCommand", "");
