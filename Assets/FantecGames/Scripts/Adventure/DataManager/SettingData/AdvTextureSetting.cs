...
namespace fantec
{
    ...
    public class AdvTextureSettingData : AdvSettingDictinoayItemBase
    {
        ...
        public override bool InitFromStringGridRow(StringGridRow row)
        {
            ...
            InitKey(key);
            this.TextureType = AdvParser.ParseCell<Type>(row, AdvColumName.Type);
            this.Graphic = new AdvGraphicInfoList(key);
            this.thumbnailName = AdvParser.ParseCellOptional<string>(row, AdvColumName.Thumbnail, "");
            this.ThumbnailVersion = AdvParser.ParseCellOptional<int>(row, AdvColumName.ThumbnailVersion, 0);
    ...
    public class AdvTextureSetting : AdvSettingDataDictinoayBase<AdvTextureSettingData>
    {
        ...
        protected override bool TryParseContinues(AdvTextureSettingData last, StringGridRow row)
        {
            ...
            string key = AdvParser.ParseCellOptional<string>(row, AdvColumName.Label, "");
