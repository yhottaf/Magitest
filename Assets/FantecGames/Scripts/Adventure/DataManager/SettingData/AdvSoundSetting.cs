...
namespace fantec
{
    ...
    public class AdvSoundSettingData : AdvSettingDictinoayItemBase, IAssetFileSoundSettingData, IAssetFileSoundSettingDataKey
    {
        ...
        {
            if (row.IsEmptyOrCommentOut) return false;
            ...
            {
                InitKey(key);
                this.Type = AdvParser.ParseCell<SoundType>(row, AdvColumName.Type);
                ...
                this.Title = AdvParser.ParseCellOptional<string>(row, AdvColumName.Title, "");
                this.IntroTime = AdvParser.ParseCellOptional<float>(row, AdvColumName.IntroTime, 0);
                this.Volume = AdvParser.ParseCellOptional<float>(row, AdvColumName.Volume, 1);
                return true;
            }
        }
